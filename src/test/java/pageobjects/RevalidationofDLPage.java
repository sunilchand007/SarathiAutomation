...
public class RevalidationofDLPage extends BasePage {
	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public RevalidationofDLPage(WebDriver driver) {
		this.driver = driver;
	...
	public void EnterEmergencyNumber(){
		stepstatus = basepage.setText(EmergencyNumber,"9999999999");	
	...
	public void ClickSubmitForServiceReqRevalidationofDL() throws IOException, InterruptedException {
