...
public class CL_ChangeOfAddress_ApplicationAcknowledgementPage extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public CL_ChangeOfAddress_ApplicationAcknowledgementPage(WebDriver driver) {
		this.driver = driver;
	...
	public void Capture_CLService_AcknowledgementDetails() {
		...
		if (title.equals("CL Transactions")) {
			setdata("CLServiceApplicationNo", AppNum.substring(3).trim());
