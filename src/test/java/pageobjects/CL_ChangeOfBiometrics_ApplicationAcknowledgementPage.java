...
public class CL_ChangeOfBiometrics_ApplicationAcknowledgementPage extends BasePage {
	BasePage basepage = new BasePage();
	WebDriver driver;
    boolean stepstatus;

	public CL_ChangeOfBiometrics_ApplicationAcknowledgementPage(WebDriver driver) {
		this.driver = driver;
