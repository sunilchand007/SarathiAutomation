...
public class CL_Services_RenewalCLPage extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public CL_Services_RenewalCLPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(how=How.XPATH, using = "//input[@id='btn_confirm_rencl']")
	WebElement Confirm;
	...
	@FindBy(how=How.XPATH, using = "//input[@id='btn_cancel_rencl']")
	WebElement Cancel;
