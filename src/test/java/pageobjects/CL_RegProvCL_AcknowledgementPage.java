...
public class CL_RegProvCL_AcknowledgementPage extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public CL_RegProvCL_AcknowledgementPage(WebDriver driver) {
	...
	public void Capture_RegProvCL_AcknowledgementDetails() {
		...
		if (title.equals("TempCLHome")) {
			setdata("ApplicationNumber", AppNum.substring(3).trim());
