...
public class CL_Services_ExtractCLPage extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public CL_Services_ExtractCLPage(WebDriver driver) {
		this.driver = driver;
	...
	public void Clickon_ShoworHidePersonalandLicenceDetails() {
		...
		reportEvent(stepstatus, "Able to click ShoworHidePersonalandLicenceDetails Button",
				"Unable to click ShoworHidePersonalandLicenceDetails Button", driver, true);
	}

	@FindBy(how = How.XPATH, using = "//textarea[@id='reasonForExtract']")
	WebElement ReasonForCLExtract;

	public void Enter_ReasonForCLExtract(String value) {
		stepstatus = basepage.setText(ReasonForCLExtract, value);
		reportEvent(stepstatus, "Able to Enter ReasonForChangeOfBiometricsCL",
				"Unable to Enter ReasonForChangeOfBiometricsCL", driver, true);
	}

	@FindBy(how = How.XPATH, using = "(//input[@id='btn_confirm_biocl'])[2]")
	WebElement Confirm;
	...
	@FindBy(how = How.XPATH, using = "(//input[@id='btn_refresh_biocl'])[2]")
	WebElement Refresh;
	...
	@FindBy(how = How.XPATH, using = "(//input[@id='btn_cancel_biocl'])[2]")
	WebElement Cancel;
