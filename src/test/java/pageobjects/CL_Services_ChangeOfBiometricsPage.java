...
public class CL_Services_ChangeOfBiometricsPage extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public CL_Services_ChangeOfBiometricsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(how = How.XPATH, using = "//textarea[@id='reasonForBiometrics']")
	WebElement ReasonForChangeOfBiometricsCL;

	public void Enter_ReasonForChangeOfBiometricsCL(String value) {
		stepstatus = basepage.setText(ReasonForChangeOfBiometricsCL, value);
		reportEvent(stepstatus, "Able to Enter ReasonForChangeOfBiometricsCL","Unable to Enter ReasonForChangeOfBiometricsCL", driver, true);
	}

	@FindBy(how = How.XPATH, using = "(//input[@id='btn_confirm_biocl'])[1]")
	WebElement Confirm;
	...
	@FindBy(how = How.XPATH, using = "(//input[@id='btn_refresh_biocl'])[1]")
	WebElement Refresh;
	...
	@FindBy(how = How.XPATH, using = "(//input[@id='btn_cancel_biocl'])[1]")
	WebElement Cancel;
