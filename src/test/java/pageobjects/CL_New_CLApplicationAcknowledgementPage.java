...
public class CL_New_CLApplicationAcknowledgementPage extends BasePage {
	BasePage basepage = new BasePage();
	WebDriver driver;
    boolean stepstatus;

	public CL_New_CLApplicationAcknowledgementPage(WebDriver driver) {
		this.driver = driver;
	...
	public void Capture_AcknowledgementDetails() {
