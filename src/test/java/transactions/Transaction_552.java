...
import pageobjects.CL_RenewalOfCL_ApplicationAcknowledgementPage;
import pageobjects.CL_Services_RenewalCLPage;
import pageobjects.StateSelectionPage;
import pageobjects.StateSpecificHomePage;
import utility.Flows;
import utility.Utilitymethods;

public class Transaction_552 extends BaseClass {
	WebDriver driver;
	...
	public void TC_RenewalOfCL()
		...
		clservice1.Clickon_RenewalOfCL();
		clservice1.Clickon_Submitbutton();
		utility = new Utilitymethods(driver);
		utility.authentication();

		CL_Services_RenewalCLPage renewal = new CL_Services_RenewalCLPage(driver);
		renewal.Clickon_ShoworHidePersonalandLicenceDetails();
		renewal.Clickon_Confirm();
		renewal.Clickon_Submit();
		CL_RenewalOfCL_ApplicationAcknowledgementPage acknowledgement = new CL_RenewalOfCL_ApplicationAcknowledgementPage(
				driver);
