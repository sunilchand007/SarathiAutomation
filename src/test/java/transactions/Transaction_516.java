...
public class Transaction_516 extends BaseClass {
	...
	public void IssueofReplacementofDLService() throws IOException, InterruptedException, ClassNotFoundException, SQLException{
		...
		dLServiceSelectionPage.selectserviceforReplaceofDL();
		dLServiceSelectionPage.ClickProceedinServiceSelectionPage();
		ReplacementofDLPage replacementDLPage= new ReplacementofDLPage(driver);
		replacementDLPage.ReplacementDL(); 
//		replacementDLPage.ClickConfirmButton(); 
//		replacementDLPage.Form_1_Check();
		...
		replacementDLPage.CheckBoxDisclaimers();
		replacementDLPage.SelectOrganDonor();
		replacementDLPage.EnterCaptcha();
		replacementDLPage.ClickSubmitForServiceReq();
	...
	/*else{
		Applicationstatus	appls=new Applicationstatus();
		appls.applicationstatusforallTransactions();
